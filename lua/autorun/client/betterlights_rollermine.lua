if CLIENT then
    ...
    local cvar_debug = BL.CreateClientConVar("betterlights_rollermine_debug", "0", true, false, "Debug hacked rollermine detection (prints to console)", nil, nil, { includeInProfiles = false })
