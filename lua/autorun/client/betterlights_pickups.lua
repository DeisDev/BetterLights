...
if CLIENT then
    -- AR2 alt-fire ammo (Combine ball ammo) — cool cyan
    ...
    local AR2C = { r = 140, g = 210, b = 255 }

    -- Battery — subtle green
    ...
    local VIAL = { r = 150, g = 255, b = 150 }

    -- Health kit — very soft white
    ...
    local KIT = { r = 255, g = 235, b = 235 }

    local function processClass(class, col, c_en, c_size, c_bright, c_decay, c_elight, c_el_mult)
