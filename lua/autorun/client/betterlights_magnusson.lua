if CLIENT then
    ...
    BL.AddThink("BetterLights_Magnusson_DLight", function()
        ...
        local function update(ent)
            ...
            BL.CreateDLight(idx, pos, gr, gg, gb, brightness, decay, size, false, BL.LIGHT_OPTIONS_GAMEPLAY)

            if doElight then
                BL.CreateDLight(idx, pos, gr, gg, gb, brightness, decay, size * elMult, true, BL.LIGHT_OPTIONS_GAMEPLAY)
            end
        end
