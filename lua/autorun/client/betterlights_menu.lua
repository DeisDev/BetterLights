if CLIENT then
    ...
    registerPage("Pickups", "BL_Pickup_HealthKit", "menu.health_kit", function(panel)
        ...
        MENU.RegisterPages("BetterLights_Menu_ClientEffects", pages)
    end
